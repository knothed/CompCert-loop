...
COMMON=Errors.v AST.v Linking.v \
  Events.v Tracex.v Globalenvs.v Memdata.v Memtype.v Memory.v Values.v \
  Behaviors.v Smallstep.v SmallstepBehaviors.v Determinacy.v Foreverx.v Bigstep.v Semantics.v SemanticsSmallBig.v \
  Switch.v Determinism.v Unityping.v Separation.v Builtins0.v Builtins1.v Builtins.v

# Back-end modules (in backend/, $(ARCH)/)

BACKEND=\
  Cminor.v Cminortyping.v \
  CminLoop.v CminLoopBigSmallEquiv.v CminLoopTransfCommon.v CminLoopRepeatTransform.v \
  DropGotos.v CminLoopRemoveSkips.v CminLoopRemoveDummys.v \
  CminLoopWhileTrue.v CminLoopUnswitching.v CminLoopInvert.v CminLoopUnroll.v \
  Op.v CminorSel.v SelectOp.v SelectDiv.v SplitLong.v SelectLong.v Selection.v \
...
DRIVER=Compopts.v CompilerSmallstep.v Compiler.v Complements.v
